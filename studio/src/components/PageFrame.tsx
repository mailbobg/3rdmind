...
export function PageFrame(p: PageFrameProps) {
  ...
  return (
    <div ref={frame} className="grid min-h-0 min-w-0 overflow-hidden rounded-2xl" style={{ gridTemplateColumns: columns, gridTemplateRows: rows, background: "var(--mm-ground)" }}>
